...
function getAjaxPlanten(){
	...
	$tbl_Planten = "<table id='plantenlijst'class='omlijnd'> <thead> <tr> <th>Product_code</th> <th>Soort</th> <th>kleur</th> <th>hoogte</th> <th>beginbloei</th> <th>eindbloei</th> <th>prijs</th> <th>rubriek</th> </tr> </thead> <tbody></tbody> </table> ";
	$soortendropdown 	= $PS->geefDDAlleSoorten();//dropdown
	$kleurendropdown 	= $PS->geefDDAlleKleuren();//array van kleuren
...
function getGalerij(){
	//Fotogalerij pagina
		...
		//extra knoppen hier
		$str .= "<p> <span id='stop' class='knop'>stop</span>"
