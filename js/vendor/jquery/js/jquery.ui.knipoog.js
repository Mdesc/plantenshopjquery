    ...
    $.widget("ui.knipoog", {
        ...
        _CSStoepassen:function(){
            ...
            switch(this.options.location){
                case "top": this.element.cap.css({top:0});
                break;
                case "bottom": this.element.cap.css({bottom:0});
                break;
                default: this.element.cap.css({top:0});
                break;
            }
        },
            ...
            self.element.hover(
                ...
                function () {
                    self.element.cap.hide('slide',{direction:"right"},o.speed, function(){
                        self._active = false;
                        if(self._destroyCalled == true) self._vernietig();
                    });
                }
            );
        },
